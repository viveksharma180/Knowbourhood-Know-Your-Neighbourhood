 ...
 * @author prath
 */
public class CreateMNCReperesentative extends javax.swing.JFrame {

    /**
     * Creates new form CreateMNCReperesentative
     */
    public CreateMNCReperesentative() {
        initComponents();
        initImage();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Create MNC Representative");
        ...
        jPanel1.setBackground(new java.awt.Color(189, 207, 217));
        ...
        jLabel12.setText("MNC Representative Details");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        super.dispose();
        MNCDashboard dm = new MNCDashboard();
        dm.setVisible(true);
    ...
    private void validateFields() {
     ...
     private void createUser() {
        try {
            MNCReperesentative r = new MNCReperesentative(nameInput.getText(), FileUtils.convertStringToDate(dobInput.getText()), Long.parseLong(contactInput.getText()), usernameInput.getText(), passwordInput.getText(), mailInput.getText());
            ArrayList<MNCReperesentative> residentsList = FileUtils.readMNCR();
            residentsList.add(r);
            FileUtils.writeMNCR(residentsList);
            JOptionPane.showMessageDialog(this, "Municipal Corporation Representative has been succesfully added!");
            super.dispose();
    ...
    private void initImage() {
        ImagePanel jPanel1 = new ImagePanel("src/assets/mncr.jpg");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateMNCReperesentative.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateMNCReperesentative().setVisible(true);
            }
        });
    }
